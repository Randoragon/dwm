...
const char *spcmd1[] = {"st", "-g", "100x30", "-n", "s_term", NULL };
const char *spcmd2[] = {"st", "-g", "100x30", "-n", "s_music", "-e", "ncmpcpp", NULL };
const char *spcmd3[] = {"st", "-g", "100x30", "-n", "s_news", "-e", "dualboat", NULL };
...
static Key keys[] = {
   /* type          modifier                      key               function        argument */
    ...
    { KeyPress,     MODKEY|Mod1Mask|ShiftMask,    XK_n,             moveplace,      {.ui = WIN_C  }},
